...
void nv::TriStrip::EnableRestart(const unsigned int _restartVal)
{
	bRestart = true;
	restartVal = _restartVal;
}

void nv::TriStrip::DisableRestart()
{
	bRestart = false;
}
...
// Default value: false
//
void nv::TriStrip::SetListsOnly(const bool _bListsOnly)
{
...
// Default value: 16
//
void nv::TriStrip::SetCacheSize(const unsigned int _cacheSize)
{
...
// Default value: true
//
void nv::TriStrip::SetStitchStrips(const bool _bStitchStrips)
{
...
// Default value: 0
//
void nv::TriStrip::SetMinStripSize(const unsigned int _minStripSize)
{
...
//  vertex buffer.
//
void nv::TriStrip::RemapIndices(const PrimitiveGroup* in_primGroups, const unsigned short numGroups,
